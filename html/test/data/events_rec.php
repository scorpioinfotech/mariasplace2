<?php
	...
	function delete_related($action){
		...
		//when serie changed or deleted we need to remove all linked events_rec
	...
	$scheduler->render_table("events_rec","event_id","start_date,end_date,event_name,rec_type,event_pid,event_length");
?>