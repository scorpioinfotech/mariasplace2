...
class BP_Friend_Suggestions_Widget extends WP_Widget {
	...
	function form( $instance ) {
			$instance = wp_parse_args( (array) $instance, array( 'title'=>__('Suggested Friends','bp-show-friends'),'max' => 5 ) );
...
function  bp_show_friend_suggestions_list($limit=5){
	...
	$user_id = $bp->loggedin_user->id;
        ...
        if(!empty($possible_friends)):?>
                       <ul id="members-list" class="item-list1 suggested-friend-item-list">
                            ...
                            <li>
                               <?php $member_link= bp_core_get_user_domain($possible_friend);
                                     $member_name=  bp_core_get_user_displayname($possible_friend);
                                      $member_id= $possible_friend;

                                ?>
                                <div class="item-avatar">
                                        <a href="<?php echo $member_link;?>"><?php echo bp_core_fetch_avatar(array('type'=>'thumb','item_id'=>$possible_friend)); ?></a>
                                </div>
                        ...
                        <?php endforeach;?>
                            ...
                            <!--  <li class="last filter" id="members-order-select">
