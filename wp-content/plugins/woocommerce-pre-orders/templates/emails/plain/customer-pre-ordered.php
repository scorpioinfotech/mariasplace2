...
if ( WC_Pre_Orders_Order::order_will_be_charged_upon_release( $order ) ) :
	...
	if ( WC_Pre_Orders_Order::order_has_payment_token( $order ) )
		echo sprintf( __( "Your pre-order has been received. You will be automatically charged for your order via your selected payment method when your pre-order is released%s Your order details are shown below for your reference.", WC_Pre_Orders::TEXT_DOMAIN ), $availability_date_text ) . "\n\n";
	else
		echo sprintf( __( "Your pre-order has been received. You will be prompted for payment for your order when your pre-order is released%s Your order details are shown below for your reference.", WC_Pre_Orders::TEXT_DOMAIN ), $availability_date_text ) . "\n\n";

else :

	echo sprintf( __( "Your pre-order has been received. You will be notified when your pre-order is released%s Your order details are shown below for your reference.", WC_Pre_Orders::TEXT_DOMAIN ), $availability_date_text )  . "\n\n";
