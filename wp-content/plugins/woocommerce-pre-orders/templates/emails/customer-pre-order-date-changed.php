...
<?php if ( $availability_date ) : ?>
	<p><?php printf( __( "Your pre-order release date has been changed. The new release date is %s. Your order details are shown below for your reference.", WC_Pre_Orders::TEXT_DOMAIN ), $availability_date ); ?></p>
<?php else : ?>
	<p><?php _e( "Your pre-order release date has been changed. Your order details are shown below for your reference.", WC_Pre_Orders::TEXT_DOMAIN ); ?></p>
<?php endif; ?>
