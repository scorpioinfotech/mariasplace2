...
class WC_Pre_Orders_Email_Pre_Ordered extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-ordered', WC_Pre_Orders::TEXT_DOMAIN );
		$this->description    = __( 'This is an order notification sent to the customer after placing a pre-order and containing order details.', WC_Pre_Orders::TEXT_DOMAIN );

		$this->heading        = __( 'Thank you for your pre-order', WC_Pre_Orders::TEXT_DOMAIN );
		$this->subject        = __( 'Your {blogname} pre-order confirmation from {order_date}', WC_Pre_Orders::TEXT_DOMAIN );
