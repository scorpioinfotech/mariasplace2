...
class WC_Pre_Orders_Email_Pre_Order_Cancelled extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-order Cancelled', WC_Pre_Orders::TEXT_DOMAIN );
		$this->description    = __( 'This is an order notification sent to the customer after a pre-order is cancelled.', WC_Pre_Orders::TEXT_DOMAIN );

		$this->heading        = __( 'Pre-order Cancelled', WC_Pre_Orders::TEXT_DOMAIN );
		$this->subject        = __( 'Your {blogname} pre-order from {order_date} has been cancelled', WC_Pre_Orders::TEXT_DOMAIN );
