			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="fav bp-secondary-action" title="Love"><span class="icon-heart2"></span></a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="unfav bp-secondary-action" title="Remove Love"><span class="icon-heart"></span> Liked</a>
