...
function buddyreshare_activity_button_title() {
	...
	function buddyreshare_activity_get_button_title(){
		...
		$title = ! empty( $activities_template->activity->reshares->css_class ) ? __( 'Shared', 'bp-reshare' ) : __( 'Share', 'bp-reshare' );
...
function buddyreshare_activity_button() {
	...
	function buddyreshare_activity_get_button(){
		...
		$link_text = '<span class="' . buddyreshare_activity_get_button_class() . '">'. $caption .'</span>';
// <span class="rs-count">' . buddyreshare_activity_get_reshares_count() . '</span>
		$button = array(
			...
			'link_text'         => $link_text,
			'link_class'        => 'reshare-button bp-secondary-action'
		);
