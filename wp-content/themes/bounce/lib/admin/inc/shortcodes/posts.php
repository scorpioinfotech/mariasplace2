...
function gp_posts($atts, $content = null) {
	...
	<div class="post-wrapper <?php echo $name.' '.$spacing; ?>">
		...
		if(get_post_meta($post->ID, 'ghostpool_thumbnail_width', true) && get_post_meta($post->ID, 'ghostpool_thumbnail_width', true) != "") {
			$thumbnail_width = get_post_meta($post->ID, 'ghostpool_thumbnail_width', true);
		} else {
			$thumbnail_width = $image_width;
		}
		if(get_post_meta($post->ID, 'ghostpool_thumbnail_height', true) != "") {
			$thumbnail_height = get_post_meta($post->ID, 'ghostpool_thumbnail_height', true);
		} else {
