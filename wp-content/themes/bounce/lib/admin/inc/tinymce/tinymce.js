...
function insertgpLink() {
	...
	var style = document.getElementById('style_panel');
		...
		if (styleid != 0 && styleid == 'posts') {
			tagtext = '['+ styleid + ' cats="" images="true" image_width="560" image_height="250" image_wrap="false" hard_crop="false" cols="1" per_page="10" link="both" orderby="date" order="desc" offset="0" content_display="excerpt" excerpt_length="400" title="true" title_size="" title_font="" meta="true" read_more="true" pagination="true" preload="false"]';	
		}
		...
		if (styleid != 0 && styleid == 'related_posts') {
			tagtext = '['+ styleid + ' id="" cats="" images="true" image_width="165" image_height="146" image_wrap="false" hard_crop="false" cols="3" per_page="3" link="both" orderby="random" order="desc" offset="0" content_display="excerpt" excerpt_length="0" title="true" title_size="" title_font="" meta="false" read_more="false" pagination="false" preload="false"]';	
		}
