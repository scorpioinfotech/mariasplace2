...
<?php if(!is_page_template('blank-page.php')) { ?>
				...
				<div class="tour">
						<div class="take_tour_btn"><a href="<?php if($_SESSION[ 'next' ] == ''){ echo get_post_meta(get_the_ID(), 'bottom_btn_link', true); }else{ echo $_SESSION[ 'next' ]; } ?>"><?php echo get_post_meta(get_the_ID(), 'bottom_btn_name', true); ?></a></div>
		</div><!-- tour -->
				<div class="clear"></div>
