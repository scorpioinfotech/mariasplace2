...
<div class="tab-lister">
					...
					<ul class="item-address">
						...
						<li>
							...
							<a href="tel:<?php the_field('telephone');?>"><?php $phone = get_field('telephone'); echo preg_replace('~.*(\d{3})[^\d]*(\d{3})[^\d]*(\d{4}).*~', '($1) $2-$3', $phone);?></a>
						</li>
						<?php } ?>
						...
						<li class="social-listing">
							...
							<a href="<?php the_field('facebook');?>" rel="nofollow"><i class="icon-facebook"></i></a>

							<?php } ?>

							<?php if(get_field('twitter')) { ?>

							<a href="<?php the_field('twitter');?>" rel="nofollow"><i class="icon-twitter"></i></a>

							<?php } ?>

							<?php if(get_field('gplus')) { ?>

							<a href="<?php the_field('gplus');?>" rel="nofollow"><i class="icon-gplus"></i></a>

							<?php } ?>

							<?php if(get_field('instagram')) { ?>

							<a href="<?php the_field('instagram');?>" rel="nofollow"><i class="icon-instagramm"></i></a>

							<?php } ?>

							<?php if(get_field('foursquare')) { ?>

							<a href="<?php the_field('foursquare');?>" rel="nofollow"><i class="icon-foursquare"></i></a>
