 ...
 *
 */
class TDP_Listings_Locations extends Empty_Widget_Abstract
{
	/**
	 * Widget settings
	 *
	...
	protected $widget = array(
		...
		// and replace!
		'name' => '[TDP] - Listings Locations',
 
		// this description will display within the administrative widgets area
		// when a user is deciding which widget to use.
		'description' => 'Use the following widget to display all the listings locations in a list.',
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'checkbox',
				'options' => array( 
				    '1' => 'Display Locations Posts Count', 
				)
			),
			array(
				'name' => '',
