 ...
 *
 */
class TDP_Listings_Categories extends Empty_Widget_Abstract
{
	/**
	 * Widget settings
	 *
	...
	protected $widget = array(
		...
		// and replace!
		'name' => '[TDP] - Listings Categories',
 
		// this description will display within the administrative widgets area
		// when a user is deciding which widget to use.
		'description' => 'Use the following widget to display all the listings categories in a list.',
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'checkbox',
				'options' => array( 
				    '1' => 'Display Categories Posts Count', 
				)
			),
			array(
				'name' => '',
	...
	function html($widget = array(), $params = array(), $sidebar = array())
	{
		...
		$args = array(
			...
			'order'              => 'ASC',
			'style'              => 'list',
			'show_count'         => $params['display_count'],
