...
/**
 * Hangar - Login Branding
 *
 * Base class for the Hangar Login Branding feature.
 *
 * @package WordPress
 * @subpackage Hangar
 * @category Bundled
...
class Hangar_Login_Branding {
	...
	public function load_settings_screen () {
		...
		$this->settings_screen = new Hangar_LoginBranding_Settings();
		
		/* Setup login branding data */
		$this->settings_screen->token = 'hangar-login-branding';
		if ( is_admin() ) {
			$this->settings_screen->name = __( 'Hangar Login Branding', 'hangar' );
			$this->settings_screen->menu_label = __( 'Login Branding', 'hangar' );
			$this->settings_screen->page_slug = 'hangar-login-branding';
		}
