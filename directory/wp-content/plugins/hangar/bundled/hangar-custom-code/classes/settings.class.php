...
/**
 * Hangar - Custom Code Settings
 *
 * Settings for the Hangar - Custom Code feature.
 *
 * @package WordPress
 * @subpackage Hangar
 * @category Bundled
 ...
 */
class Hangar_CustomCode_Settings extends Hangar_Settings_API {
	...
	public function init_sections () {
	    ...
	    $sections['custom-css'] = array(
	    						'name' => __( 'Custom CSS', 'hangar' ), 
	    						'description' => __( 'Add custom CSS code to your website.', 'hangar' )
	    						);

	    if ( current_user_can( 'unfiltered_html' ) ) {
		    $sections['custom-html'] = array(
		    						'name' => __( 'Custom HTML', 'hangar' ), 
		    						'description' => __( 'Add custom HTML code to the &lt;head&gt; section or before the closing &lt;/body&gt; tag on your website.', 'hangar' )
	    							);
		}
	...
	public function init_fields () {
	    ...
	    $fields['custom-css-enable'] = array(
	    						'name' => __( 'Enable Custom CSS', 'hangar' ), 
	    						'description' => __( 'Output the custom CSS code on your website.', 'hangar' ), 
	    						'type' => 'checkbox', 
	    						'default' => '', 
	    						'section' => 'custom-css', 
	    						'required' => 0
	    ...
	    $fields['custom-css-code'] = array(
	    						'name' => __( 'Custom CSS Code', 'hangar' ), 
	    						'description' => __( 'Output this custom CSS code on your website.', 'hangar' ), 
	    						'type' => 'css', 
	    						'default' => '', 
	    						'section' => 'custom-css', 
	    						'required' => 0, 
	    ...
	    if ( current_user_can( 'unfiltered_html' ) ) {
		    $fields['custom-html-enable'] = array(
		    						'name' => __( 'Enable Custom HTML', 'hangar' ), 
		    						'description' => __( 'Output the custom HTML code on your website.', 'hangar' ), 
		    						'type' => 'checkbox', 
		    						'default' => '', 
		    						'section' => 'custom-html', 
		    						'required' => 0
		    ...
		    $fields['custom-html-code-head'] = array(
		    						'name' => __( 'Inside the &lt;head&gt; Tags', 'hangar' ), 
		    						'description' => __( 'Output custom HTML code inside the &lt;head&gt; tags of your website (JavaScript is not permitted).', 'hangar' ), 
		    						'type' => 'html', 
		    						'default' => '', 
		    						'section' => 'custom-html', 
		    						'required' => 0, 
		    ...
		    $fields['custom-html-code-footer'] = array(
		    						'name' => __( 'Before the closing &lt;/body&gt; Tag', 'hangar' ), 
		    						'description' => __( 'Output custom HTML code before the closing &lt;/body&gt; tag of your website (JavaScript is not permitted).', 'hangar' ), 
		    						'type' => 'html', 
		    						'default' => '', 
		    						'section' => 'custom-html', 
		    						'required' => 0, 
