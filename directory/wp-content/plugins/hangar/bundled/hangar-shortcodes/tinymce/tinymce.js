    ...
    tinymce.create('tinymce.plugins.button', {  
        init : function(ed, url) {  
            ed.addButton('button', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[button link="http://www.google.com" size="small, medium, large" target="_blank or _self" icon="icon-cog" color="white, yellow, orange, red, blue, green, gray, black" lightbox="true or false"]Button[/button]');  
    ...
    tinymce.create('tinymce.plugins.icon', {  
        init : function(ed, url) {  
            ed.addButton('icon', {  
                ...
                image : url+'/icon.png',  
                onclick : function() {  
                     ed.selection.setContent('[icon icon="icon-cash"]');  
    ...
    tinymce.create('tinymce.plugins.miniicon', {  
        init : function(ed, url) {  
            ed.addButton('miniicon', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[mini-icon icon="icon-leaf"]');  
    ...
    tinymce.create('tinymce.plugins.iconbox', {  
        init : function(ed, url) {  
            ed.addButton('iconbox', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[iconbox icon="icon-music" title="This is awesome!"]Your Content here...[/iconbox]');  
    ...
    tinymce.create('tinymce.plugins.retinaicon', {  
        init : function(ed, url) {  
            ed.addButton('retinaicon', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[retinaicon icon="icon-beaker" size="small, medium, large" circle="true or false" color="#999999" background="#efefef" align="center"]');  
    ...
    tinymce.create('tinymce.plugins.retinaiconbox', {  
        init : function(ed, url) {  
            ed.addButton('retinaiconbox', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[retinaiconbox icon="icon-beaker" circle="true or false" color="#289dcc" background="#efefef" title="Incredibly Flexible"]Your Content here...[/retinaiconbox]');  
    ...
    tinymce.create('tinymce.plugins.list', {  
        init : function(ed, url) {  
            ed.addButton('list', {  
                ...
                image : url+'/list.png',  
                onclick : function() {  
                     ed.selection.setContent('[list]<br />[list_item icon="icon-glass"]glass[/list_item]<br />[list_item icon="icon-music"]music[/list_item]<br />[list_item icon="icon-search"]search[/list_item]<br />[list_item icon="icon-envelope"]envelope[/list_item]<br />[/list]');  
    ...
    tinymce.create('tinymce.plugins.member', {  
        init : function(ed, url) {  
            ed.addButton('member', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[member name="John Doe" role="Web Developer" url="http://example.com" img="" twitter="http://twitter.com" facebook="http://facebook.com" skype="http://skype.com" google="http://google.com" linkedin="http://linkedin.com" mail="hellohangar@gmail.com"]Description[/member]');  
    ...
    tinymce.create('tinymce.plugins.pricing', {  
        init : function(ed, url) {  
            ed.addButton('pricing', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[pricing-table col="2"]<br />[plan name="Starter Edition" link="http://www.google.com" linkname="Sign Up" price="19$" per="per year" color="#83b732" featured="Best Price"]<ul><li>Item 1</li></ul>[/plan]<br />[plan name="Starter Edition" link="http://www.google.com" linkname="Sign Up" price="49$" per="per month" color="#999999"]<ul><li>Item 1</li></ul>[/plan]<br />[/pricing-table]');  
    ...
    tinymce.create('tinymce.plugins.socialmedia', {  
        init : function(ed, url) {  
            ed.addButton('socialmedia', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[social icon="icon-facebook" url="http://facebook.com"]');  
    ...
    tinymce.create('tinymce.plugins.tabs', {  
        init : function(ed, url) {  
            ed.addButton('tabs', {  
                ...
                image : url+'/tabs.png',  
                onclick : function() {  
                     ed.selection.setContent('[tabgroup]<br />[tab title="Tab 1"]Tab 1 content goes here.[/tab]<br />[tab title="Tab 2" icon="icon-file"]Tab 2 content goes here.[/tab]<br />[tab icon="icon-file"]Tab 3 content goes here.[/tab]<br />[/tabgroup]');  
    ...
    tinymce.create('tinymce.plugins.toggle', {  
        init : function(ed, url) {  
            ed.addButton('toggle', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[toggle title="Toggle Title" open="true or false" icon="icon-star"]Your Content goes here...[/toggle]');  
