jQuery(document).ready( function($) {
	...
	jQuery( '#hangar .subsubsub a.tab' ).click( function ( e ) {
		...
		if ( jQuery( this ).hasClass( 'all' ) ) {
			jQuery( '#hangar h3, #hangar form p, #hangar table.form-table, p.submit' ).show();
		...
		jQuery( '#hangar h3, #hangar form > p:not(".submit"), #hangar table' ).hide();
