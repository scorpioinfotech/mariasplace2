...
/**
 * Hangar Administration Class
 *
 * All functionality pertaining to the administration sections of Hangar.
 *
 * @package WordPress
 * @subpackage Hangar
 ...
 */
class Hangar_Admin extends Hangar_Base {
	public $model;
	public $hook;
	private $whitelist;
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_hangar_component_toggle', array( &$this, 'ajax_component_toggle' ) );
		add_action( 'wp_ajax_hangar_component_display_toggle', array( &$this, 'ajax_component_display_toggle' ) );
		add_action( 'wp_ajax_hangar_get_closed_components', array( &$this, 'ajax_get_closed_components' ) );
	 ...
	 * @access public
	 * @since 1.0.0
	 * @uses global $hangar->settings
	 * @uses global $hangar->api->refresh()
	 * @return void
	 */
	public function admin_page_load () {
		...
		// Get the settings.
		$hangar->settings = $hangar->api->get_settings();
		...
		$default = 'Hangar_Model';
		$filetoken = 'model';
		
		// Force refresh if necessary.
		if ( $screen == 'main' & $hangar->settings->refresh == true ) {
			$hangar->api->refresh();
		}
	...
	public function admin_scripts () {
		...
		$translation_strings = Hangar_Utils::load_common_l10n();
